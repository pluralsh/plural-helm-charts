...
{{ include "etcd-operator.controllerSelectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "etcd-operator.controllerSelectorLabels" -}}
app.kubernetes.io/name: {{ include "etcd-operator.name" . }}-controller
...
Selector labels
*/}}
{{- define "etcd-operator.proxySelectorLabels" -}}
app.kubernetes.io/name: {{ include "etcd-operator.name" . }}-proxy
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
